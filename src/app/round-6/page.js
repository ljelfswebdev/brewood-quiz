...
import data from '../../../data/round-6.json';
import { Swiper, SwiperSlide } from 'swiper/react';
import { Pagination } from 'swiper/modules';
import createPagination from '../../../components/pagination';

const RoundSix = ({ folder = '/', is_image_round = false }) => {
    ...
    return ( 
        <>
            ...
            >
                {hasTitle && <SwiperSlide className="page__slide">Round 6 - {titleItem.title}</SwiperSlide>}
                ...
                <SwiperSlide className="page__slide">End Of Round 6</SwiperSlide>
            </Swiper>
        </>
    );
}
